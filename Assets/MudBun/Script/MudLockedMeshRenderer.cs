...
namespace MudBun
{
  ...
  public class MudLockedMeshRenderer : MonoBehaviour, ISerializationCallbackReceiver
  {
    ...
    [SerializeField] [HideInInspector] private Aabb m_renderBoundsRs;
    ...
    )
    {
      ...
      m_renderBoundsRs = renderer.RenderBoundsRs;
    ...
    private void Render()
    {
      if (m_indirectDrawArgsBuffer == null 
          || m_genPointsBuffer == null 
          || RenderMaterial == null 
          || m_renderBoundsRs.IsEmpty 
          || RenderMaterial == null)
        return;

      BindRenderResources();

      var renderBounds = m_renderBoundsRs;
